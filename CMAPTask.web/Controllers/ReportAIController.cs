...
namespace OpenBanking.web.Controllers
{
    public class ReportAIController : Controller
    {
        ...
        public ReportAIController(IRiskAnalyzer riskAnalyzer, IHttpContextAccessor httpContextAccessor, IOptions<OBSettings> options, ITransactionsRepository transactionsRepository)
        {
